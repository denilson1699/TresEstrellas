...
public class ColorCeldaTabla extends DefaultTableCellRenderer{
    ...
    this.setBackground(new Color(230,230,230));//color de fondo new Color (51,255,102)
    }
    else{
    this.setBackground(new Color(250,250,250));// Color de fondo new Color(204,255,204)
    }
