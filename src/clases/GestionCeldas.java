...
public class GestionCeldas extends DefaultTableCellRenderer{
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        Color colorFondoPorDefecto=new Color( 0, 192, 192);
        Color colorFondoSeleccion=new Color( 140, 0 , 140);
        ...
        if( tipo.equals("texto"))
        {
            ...
            this.setBackground( (selected)? colorFondo :Color.black);	
            this.setFont(normal);   
            //this.setFont(bold);
            return this;
        }
...
//            return boton;
        ...
        */
        ...
        {           
            ...
            this.setText( (String) value );            
            this.setForeground( (selected)? new Color(255,0,0) :new Color(0,0,32) );    
