 ...
 * @author Usuario
 */
public class ProcesoVentasFactura extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProcesoVentas
     */
     int contador=0; 
   ...
   jLabel_year.setText(year);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("FACTURA ELÉCTRONICA");
        ...
        jLabel_serie.setForeground(new java.awt.Color(255, 0, 0));
        jLabel_serie.setText("E001 -");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_razonCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE)
                            .addComponent(txt_direcCliente)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel19)
                        .addGap(64, 64, 64)
                        .addComponent(txt_rucCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void boton_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_nuevoActionPerformed
        ...
        txt_codigoPro.setText("");
           ...
           txt_cantidad.setText("");
            ...
            txt_rucCliente.setBackground(new Color(255,255,153));
    ...
    private void boton_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_AgregarActionPerformed
      ...
      String  codigoPro,descrip,precio1,monto1, rucCliente; int cantidad1, stokRestante = 0, id_ventaIndividual= 0;
      ...
      rucCliente=txt_rucCliente.getText().trim();
      ...
      if(monto1.equals("00.00")){
        ...
        txt_rucCliente.setBackground(new Color(250,150,150));
        contador++;
        }
        ...
        contador++;
           ...
           try 
                 ...
                 pst1.setInt(1,0);
                 pst1.setString(2,rucCliente );
                 pst1.setString(3,codigoPro );
                 pst1.setString(4,"FACTURA" );
                 pst1.setString(5,"E001");
       ...
       try {
           ...
           if(resulx.next()){
            ...
            cnx.close();
              ...
              { System.err.println("error en recuperar id pedido individual :"+e);}
 ...
 // eliminar datos de la base de datos
    ...
    int contado=0;
    String numeroVenta,ruc,dni_empleado, total_venta;
    numeroVenta=jLabel_numeroVenta.getText();
    ruc=txt_rucCliente.getText().trim();
    ...
    if(contado==0){
      try {
      Connection cn=Conexion.Conectar();
      PreparedStatement pst= cn.prepareStatement("insert into tabla_venta_facturas values (?,?,?,?,?,?,?,?,?)");
      pst.setInt(1,0);
      pst.setString(2, "E001");
      pst.setString(3,numeroVenta  );
      pst.setString(4,ruc );
      pst.setString(5,total_venta  );
      pst.setString(6,dia);
      pst.setString(7,mes);
      pst.setString(8,year);
      pst.setString(9,dni_empleado);
      pst.executeUpdate();
      cn.close();
      int mensaje=JOptionPane.showConfirmDialog(null,"Venta Registrada, ¿Imprimir? :",null,JOptionPane.YES_NO_OPTION);
        ...
        //**********************************************************
         Document BoletaVenta= new Document();
            ...
            PdfWriter.getInstance(BoletaVenta,new FileOutputStream(ruta+"/Desktop/FE "+FechaActual+" "+txt_razonCliente.getText().trim()+".pdf"));
            BoletaVenta.open();
            ...
            ParrafoDatos.setFont(FontFactory.getFont("Tahoma",12,Font.BOLD, BaseColor.BLACK));//fuente,tamaño,negrita,color
            ParrafoDatos.add(" FATURA ELECTRÓNICA \n" );
            ParrafoDatos.setFont(FontFactory.getFont("Tahoma",12,Font.ROMAN_BASELINE, BaseColor.RED)); 
            ParrafoDatos.add("Serie: E001 - "+jLabel_numeroVenta.getText()); 
            ...
            ParrafoDatosCliente.add("Ruc : ");
            ParrafoDatosCliente.setFont(FontFactory.getFont("Tahoma",12,Font.ROMAN_BASELINE, BaseColor.BLACK));
            ParrafoDatosCliente.add(txt_rucCliente.getText().trim()+" \n" );
            
            ParrafoDatosCliente.setFont(FontFactory.getFont("Tahoma",10,Font.BOLD, BaseColor.BLACK));//fuente,tamaño,negrita,color
            ParrafoDatosCliente.add("Razón Social  : ");
            ParrafoDatosCliente.setFont(FontFactory.getFont("Tahoma",12,Font.ROMAN_BASELINE, BaseColor.BLACK));
            ParrafoDatosCliente.add(txt_razonCliente.getText().trim()+" \n" );
            
            ParrafoDatosCliente.setFont(FontFactory.getFont("Tahoma",10,Font.BOLD, BaseColor.BLACK));//fuente,tamaño,negrita,color
            ParrafoDatosCliente.add("Dirección     : ");
            ParrafoDatosCliente.setFont(FontFactory.getFont("Tahoma",12,Font.ROMAN_BASELINE, BaseColor.BLACK));
   ...
   try 
      ...
      String valRuc;
      Connection cn1= Conexion.Conectar();
      PreparedStatement pst1= cn1.prepareStatement("select Ruc_cliente  from tabla_clientesruc where Ruc_cliente ='"+RUC+"'");
      ResultSet resul1=pst1.executeQuery();
      if(resul1.next())
      {
      valRuc=resul1.getString("Ruc_cliente");
       
      //RECUPERAR DATOS AL ENCONTRAR DNI EN LA BD
      if (RUC.equals(valRuc))
      {
          try{
      Connection cn2= Conexion.Conectar();
      PreparedStatement pst2= cn2.prepareStatement("select  Razon_cliente,direccion_cliente from tabla_clientesruc  where Ruc_cliente='"+RUC+"'");
      ResultSet resul2=pst2.executeQuery();
        if(resul2.next())
        {
        txt_razonCliente.setText(resul2.getString("Razon_cliente"));
        txt_direcCliente.setText(resul2.getString("direccion_cliente"));
        cn2.close();
        }}catch (SQLException ex) {System.out.println("error al buscar ruc cliente: "+ex);}
      }
      }          
      else
      {//GUARDAR AL CLIENTE NUEVO
         JOptionPane.showMessageDialog(null, "Cliente no Registrado, GUARDAR","", JOptionPane.WARNING_MESSAGE);
         RegistrarClienteRucNew registrarClienteRucNew= new RegistrarClienteRucNew();
         registrarClienteRucNew.setVisible(true);
      }
      }catch (SQLException e) {System.out.println("error al validar ruc :"+e);}
   }
   ...
   // limpiar campos y canbcelar venta
    ...
    public void GenerarSerieFactura(){
        // creamos metodo para RECUPERAR LA ULTIMA SERIE
      String serie="";
        try {
            Connection cn=Conexion.Conectar();
            PreparedStatement pst= cn.prepareStatement("SELECT MAX(Numero_ventaFac) AS Numero_ventaFac FROM tabla_venta_facturas");
